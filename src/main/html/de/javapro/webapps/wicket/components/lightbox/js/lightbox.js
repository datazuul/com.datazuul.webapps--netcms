...
LightboxOptions = Object.extend({
    fileLoadingImage:        '${webappContext}/resources/de.javapro.webapps.wicket.components.lightbox.LightBox2Panel/images/loading.gif',
    fileBottomNavCloseImage: '${webappContext}/resources/de.javapro.webapps.wicket.components.lightbox.LightBox2Panel/images/closelabel.gif',
...
Lightbox.prototype = {
    ...
    start: function(imageLink) {    
        ...
        $('overlay').setStyle({height: arrayPageSize[1] + 'px' }); //Change Steve Schuckman from arrayPageSize[3] to arrayPageSize[1]
    ...
    adjustImageSize: function( recall ) {
		...
		this.overlay.setStyle({ height: arrayPageSize[1] + 'px' }); //Change Steve Schuckman from arrayPageSize[3] to arrayPageSize[1]
