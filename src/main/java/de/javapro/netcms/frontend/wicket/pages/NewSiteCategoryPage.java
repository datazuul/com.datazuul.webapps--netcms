 ...
 * 
 */
public class NewSiteCategoryPage extends AuthenticatedWebPage {
    private static LoggerFacade LOG = LoggerFacade.getInstance(NewSiteCategoryPage.class);

    public NewSiteCategoryPage() {
	buildPage();
    }
	...
	public final void onSubmit() {
	    ...
	    // then save as site category
	    final List<Category> categories = repository.getSiteCategories(dn);
	    categories.add(category);
	    repository.saveSiteCategories(dn, categories);
